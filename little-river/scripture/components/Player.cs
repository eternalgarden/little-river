...
{
    [Export]
    public string InputBackActionName { get; set; } = "move_backward";

    [Export]
    public string InputForwardActionName { get; set; } = "move_forward";

    [Export]
    public string InputLeftActionName { get; set; } = "move_left";

    [Export]
    public string InputRightActionName { get; set; } = "move_right";

    [Export]
    public string InputSprintActionName { get; set; } = "move_sprint";

    [Export]
    public string InputJumpActionName { get; set; } = "move_jump";

    [Export]
    public string InputCrouchActionName { get; set; } = "move_crouch";

    [Export]
    public string InputFlyModeActionName { get; set; } = "move_fly_mode";

    [Export]
    public Godot.Environment UnderwaterEnv { get; set; }
    ...
    public override void _Ready()
    {
        ...
        CallDeferred(MethodName.CaptureMouse);
    }
    ...
    public override void _PhysicsProcess(double delta)
    {
        ...
        if (IsValidInput)
        {
            ...
            Vector2 InputAxis = Input.GetVector(
                InputBackActionName,
                InputForwardActionName,
                InputLeftActionName,
                InputRightActionName
            );

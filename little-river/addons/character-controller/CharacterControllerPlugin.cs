...
public partial class CharacterControllerPlugin : EditorPlugin
{
    private static readonly Dictionary<string, object> CharacterControllerForward = new()
    {
        { "name", "move_forward" },
        {
            ...
            new List<object>
            {
                new Dictionary<string, object> { { "physical_keycode", (int)Godot.Key.W } },
            }
        },
    };
    ...
    private static readonly Dictionary<string, object> CharacterControllerBackward = new()
    {
        { "name", "move_backward" },
        {
            ...
            new List<object>
            {
                new Dictionary<string, object> { { "physical_keycode", (int)Godot.Key.S } },
            }
        },
    };
    ...
    private static readonly Dictionary<string, object> CharacterControllerRight = new()
    {
        { "name", "move_right" },
        {
            ...
            new List<object>
            {
                new Dictionary<string, object> { { "physical_keycode", (int)Godot.Key.D } },
            }
        },
    };
    ...
    private static readonly Dictionary<string, object> CharacterControllerLeft = new()
    {
        { "name", "move_left" },
        {
            ...
            new List<object>
            {
                new Dictionary<string, object> { { "physical_keycode", (int)Godot.Key.A } },
            }
        },
    };
    ...
    private static readonly Dictionary<string, object> CharacterControllerSprint = new()
    {
        { "name", "move_sprint" },
        {
            ...
            new List<object>
            {
                new Dictionary<string, object> { { "physical_keycode", (int)Godot.Key.Shift } },
            }
        },
    };
    ...
    private static readonly Dictionary<string, object> CharacterControllerJump = new()
    {
        { "name", "move_jump" },
        {
            ...
            new List<object>
            {
                new Dictionary<string, object> { { "physical_keycode", (int)Godot.Key.Space } },
            }
        },
    };
    ...
    private static readonly Dictionary<string, object> CharacterControllerCrouch = new()
    {
        { "name", "move_crouch" },
        {
            ...
            new List<object>
            {
                new Dictionary<string, object> { { "physical_keycode", (int)Godot.Key.Ctrl } },
            }
        },
    };
    ...
    private static readonly Dictionary<string, object> CharacterControllerFlyMode = new()
    {
        { "name", "move_fly_mode" },
        {
            ...
            new List<object>
            {
                new Dictionary<string, object> { { "physical_keycode", (int)Godot.Key.F } },
            }
        },
    };
    ...
    public override void _EnterTree()
    {
        ...
        foreach (var actionProps in Actions)
        {
            ...
            if (!ProjectSettings.HasSetting(settingName))
            {
                ...
                float deadzone = actionProps.ContainsKey("deadzone")
                    ? (float)actionProps["deadzone"]
                    : 0.5f;
